...
<body>
    ...
    <header>
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <a class="btn btn-primary btn-lg mr-3" href="#" role="button">Registro de productos</a>
            <a class="btn btn-success btn-lg ml-3" href="#" role="button">Productos en Bodega</a>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <form>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <input type="text" required class="form-control" placeholder="Marca/Editorial del producto" name="marcaProducto">
                    </div>
                </div>

                <div class="form-group mt-5">
                    <input type="number" required class="form-control" id="inputAddress2" placeholder="Precio del producto" name="precioProducto">
                </div>
                <div class="form-group mt-5">
                    <input type="number" required class="form-control" id="inputAddress2" placeholder="Descripción del producto" name="descripcionProducto">
                </div>
